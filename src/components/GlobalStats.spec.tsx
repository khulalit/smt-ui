...
describe("GlobalStats", () => {
  const mockProps = {
    ...
    countryHeadCount: 320,
  };

  it("renders total global headcount section", () => {
    render(<GlobalStats {...mockProps} />);

    expect(screen.getByText(/total global headcount/i)).toBeInTheDocument();
  ...
  it("renders annualized payroll section", () => {
    ...
    expect(screen.getByText(/annualized payroll/i)).toBeInTheDocument();
  ...
  it("renders average global salary", () => {
    ...
    expect(screen.getByText(/avg global salary:/i)).toBeInTheDocument();
  ...
  it("renders active region focus section", () => {
    ...
    expect(screen.getByText(/active region focus/i)).toBeInTheDocument();
  });
  ...
  it("renders active status text", () => {
    ...
    expect(screen.getByText(/across 10 global regions/i)).toBeInTheDocument();
  });
